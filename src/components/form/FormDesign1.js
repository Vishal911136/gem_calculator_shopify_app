...
export default function FormDesign1() {
  ...
  return (
    <>
          <form
            className="rounded-[10px] col-span-3 lg:col-span-2 w-auto bg-white p-[25px] md:p-[80px] sm:p-[35px]"
            onSubmit={findGems}
            style={{boxShadow: "0px 4px 58px 0px rgba(0, 0, 0, 0.25)"}}
          >
            <h1 style={{color: themeSetting.form.color}} className="text-[#813C01] text-[20px] md:text-[20px] leading-none sm:pb-[20px] font-[500] font-libra">
            ...
            <div className={`grid grid-cols-1 gap-x-[25px] mt-[22px] gap-y-[20px] ${themeSetting.tableimage.enable === false ?  'md:grid-cols-3' : 'md:grid-cols-2' }`}>
              <div>
                <label 
                  ...
                  className={`block text-[13px] tracking-normal sm:text-[16px]  mb-[4px] text-[#664421] font-manrope`}
                >
                  Enter your name
                </label>
                <div className="">
                  <input
                    ...
                    className="block w-full rounded-[40px] border px-[20px] text-[14px] sm:text-[16px] py-[15px] sm:py-[15px] placeholder:text-gray-300 focus:border-gray-400 outline-none shadow-none font-manrope"
              ...
              <div>
                ...
                <div className="">
                  <input
                    ...
                    id="phone"
                    autoComplete="given-name"
                    className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none block w-full rounded-[40px] border px-[20px] text-[14px] sm:text-[16px] py-[15px] sm:py-[15px] placeholder:text-gray-300 focus:border-gray-400 outline-none shadow-none font-manrope"
              ...
              <div>
                ...
                <div className="select-container">
                  <select
                    ...
                    required
                    className="block w-full rounded-[40px] border px-[20px] text-[14px] sm:text-[16px] py-[15px] sm:py-[15px] placeholder:text-gray-300 focus:border-gray-400 outline-none shadow-none font-manrope bg-white"
              ...
              <div className="mt-[40px] w-full">
                <button
                    ...
                    className="block w-full  rounded-[40px] btn_color px-4 py-[12px] sm:py-[12px] text-center text-[20px] font-[500] bg-[#00182E] text-white hover:shadow-lg hover:bg-[#F0ECE9] hover:opacity-[.8]"
                    >
                    Submit
                </button>
              </div>
